...
Diagrams: [the Syncthing mesh](https://claude.ai/code/artifact/8822bb68-ae51-4b70-a06c-58db3aed3cf1)
(live) and [the Obsidian Sync trial](https://claude.ai/code/artifact/e20f570e-e4e2-4410-9b1c-32d30e2270c8).
...
- [ ] Domain + DNS. Not blocking: exe.dev supplies a hostname with TLS and Tailscale carries sync, so this is only wanted for the publishing surface (§8).
